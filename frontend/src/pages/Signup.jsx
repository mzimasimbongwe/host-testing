...
function Signup() {
  ...
  const validateForm = () => {
    ...
    if (validator.isEmpty(email)) {
      validationErrors.email = "Email is requuired";
    ...
    if (validator.isEmpty(passwordr)) {
      validationErrors.passwordr = "Confirm Password is required";
    }

    if (password !== passwordr) {
      validationErrors.passwordr = "Passwords do not match";
      setPassword("");
      setPasswordr("");
    }
        ...
        <div className="flex flex-wrap justify-center items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {message && (
                <div className="flex justify-center text-red-600 p-4 mb-4">
                  {message}
                </div>
              )}
